...
class OpenWebService():
	...
	def PUT(self, **params):
		# il put mi gestisce tutte le richieste di put e delete che vengono indirizzate catalog
		my_string = cherrypy.request.body.read()
...
if __name__ == '__main__':
	...
	url_catalog = settings["catalogURL"] # prendo dai setting l'url del catalog
	api_key = settings["api_key_thingspeak"] # prendo dai setting la chiave per creare canali thingspeak
	conf={
		'/':{
