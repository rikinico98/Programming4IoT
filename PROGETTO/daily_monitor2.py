...
if __name__ == '__main__':
   # da passare tramite BOT 
    r_TS = requests.get(f'http://127.0.0.1:8070/catalog/R_004/TS_utilities')
    j_TS = json.dumps(r_TS.json(),indent=4)
    d_TS = json.loads(j_TS)
    TS=d_TS["ThingSpeak"]
    apikey =TS["api_key_read"] #'422ZLZJ4E5UTZXCE' #va preso dal Catalog
    channelID = TS["channelID"]#1322346 #va preso dal Catalog
