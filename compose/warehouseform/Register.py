...
class RegisterWebService():
    ...
    def __init__(self, url_catalog, api_key):
        ...
        # il link che rimanda a thingspeak è uguale sempre, quindi lo si può inserire 
        # direttamente nel codice perchè non cambierà mai
        ...
        # api key per creare canali (massimo 4 canali, limitazione di thingspeak)
    ...
    def POST(self):
        ...
        elif new_device["command"] == "insert_room":
            body = new_device["body"]
        ...
        # per inserire un nuovo utente nel Catalog
        elif new_device["command"] == "insert_user":
            body = new_device["body"]
            print(json.dumps(body, indent=4))
            r = requests.post(
                self.url_catalog +
            ...
            raise cherrypy.HTTPError(400, "Unexpected command on the body")
...
if __name__ == '__main__':
    ...
    cherrypy.tree.mount(RegisterWebService(url_catalog, api_key), '/', conf)
